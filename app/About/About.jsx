...
function About() {
  ...
  <RoughNotation type="circle" show={false} color="orange" className="font-semibold" order={1}>
    Mobile and Web development
  </RoughNotation>{' '}
  with a strong dedication to quality and{' '}
  <RoughNotation type="highlight" show={false} className="font-semibold" color="orange" order={2}>
    attention to{' '}
  </RoughNotation>
  <RoughNotation type="highlight" show={false} className="font-semibold" color="orange" order={2}>
  detail
  ...
  <RoughNotation type="highlight" show={false} className="font-semibold" color="orange" order={3}>
  ...
  , and{' '}
  <RoughNotation type="underline" show={false} className="font-semibold" color="orange" order={5}>
    experimenting with new technologies
  </RoughNotation>
  . I build{' '}
  <RoughNotationGroup type="highlight" show={false} className="font-semibold" color="orange" order={6}>
   functional{' '}
  </RoughNotationGroup>

  <RoughNotationGroup type="highlight" show={false} className="font-semibold" color="orange" order={7}>
    beautiful{' '}
  </RoughNotationGroup>

  <RoughNotationGroup type="highlight" show={false} className="font-semibold" color="orange" order={8}>
